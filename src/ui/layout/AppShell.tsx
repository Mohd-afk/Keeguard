...
import { AuthScreen } from '@/ui/compositions/AuthScreen';
import { getSettings, loadSettingsWithCloud, clearSession, clearLocalVaultData, getVaultItems, permanentlyDeleteVaultItem, addVaultChangeListener, subscribeToCustomCategories, type CustomCategory, type VaultItem } from '@/app/store';
import { onAuthChange, signOut, isVerificationLink } from '@/app/auth';
import { getFirebaseAuth } from '@/app/firebase';
import type { User } from 'firebase/auth';
import { createLogger } from '@/app/utils/logger';
import { registerCurrentDevice, listenForRevocation, updateLastActive } from '@/app/services/deviceSession';
import { saveUserEmailToProfile } from '@/app/firestore';
import { Sidebar, type SidebarFilter } from './Sidebar';
import { NotificationDrawer } from '@/ui/compositions/NotificationDrawer';
import { ConflictResolverSheet } from '@/ui/compositions/ConflictResolverSheet';
import { initNotificationsStore } from '@/app/stores/notificationsStore';
...
export function AppShell() {
  ...
  // ── Unlocked vault ───────────────────────────────────────────────
  return (
    <div className="w-full min-h-screen bg-[#1a1a2e] relative overflow-hidden md:pl-[300px] flex flex-col">
      <Sidebar
        open={sidebarOpen}

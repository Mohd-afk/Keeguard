...
export function BottomNav({ active, onChange }: BottomNavProps) {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-30 bg-[#1a1a2e]/95 backdrop-blur-md border-t border-white/5 flex justify-around items-center pb-[max(env(safe-area-inset-bottom),_4px)] md:hidden"

...
import type { VaultItem } from '@/app/store';
...
} from '@/app/firestore/collections';
...
export function Sidebar({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 left-0 z-50 h-full w-[300px] max-w-[85vw] md:max-w-none bg-[#16213e] flex flex-col shadow-2xl md:shadow-none md:border-r md:border-white/5 transition-transform duration-300 ease-out md:translate-x-0 ${

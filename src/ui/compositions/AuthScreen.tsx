...
import { deriveAuthKey } from '@/app/crypto';
import { hasConfiguredVault, setupInitialVault, setSessionPassword, resetVault, setPendingAutoUnlockPassword } from '@/app/store';
import { checkUsernameAvailable, claimUsername, checkEmailRegistered, registerEmail } from '@/app/firestore';
...
import { getRateLimitState, recordFailedAttempt, clearRateLimit, forceHardLockout } from '@/app/utils/rateLimit';

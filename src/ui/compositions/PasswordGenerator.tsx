...
import { BottomNav, type BottomTab } from '@/ui/layout/BottomNav';
...
export function PasswordGenerator() {
  ...
  return (
    <div className="min-h-screen max-h-screen overflow-hidden flex flex-col relative animate-page">
      ...
      {/* Bottom buttons */}
      <div className="fixed bottom-[calc(max(env(safe-area-inset-bottom),_0px)_+_64px)] left-0 md:left-[300px] right-0 max-w-xl mx-auto bg-[#1a1a2e]/95 backdrop-blur-md border-t border-white/5 px-4 py-4 flex gap-3 z-20">
        <button
          onClick={generate}
      ...
      {clipboardCountdown !== null && (
        <div className="fixed bottom-[calc(max(env(safe-area-inset-bottom),_0px)_+_144px)] left-0 md:left-[300px] right-0 max-w-xl mx-auto flex items-center justify-center gap-1.5 py-2 bg-[#16213e]/95 border-t border-white/5 text-gray-500 text-xs z-20">

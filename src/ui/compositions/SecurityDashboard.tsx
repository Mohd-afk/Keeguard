...
import { getVaultItems, type VaultItem } from '@/app/store';
import { checkBatch, type HibpBatchResult } from '@/app/services/hibpCache';
    ...
    return (
      <div className="h-screen max-h-screen bg-[#1a1a2e] flex flex-col animate-page overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 gap-6">
          ...
          <p className="text-gray-600 text-xs text-center max-w-xs leading-relaxed mt-4">

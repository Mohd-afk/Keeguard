...
import { Plus, ArrowLeft, Shield, Users, ArrowRight, FolderPlus, Loader2, Tag, Key } from 'lucide-react';
          ...
          <div className="flex flex-col gap-3">
            {collectionIds.map((cid) => {
              ...
              return (
                <button
                  key={cid}
                  onClick={() => navigate(`/collections/${cid}`)}
                  className="w-full flex items-center justify-between p-4 bg-[#16213e] hover:bg-[#16213e]/70 border border-white/5 rounded-2xl text-left transition-all active:scale-[0.98] group"
                >

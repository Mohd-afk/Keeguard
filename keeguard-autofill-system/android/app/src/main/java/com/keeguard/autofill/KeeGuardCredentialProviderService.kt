...
/**
 * KeeGuardCredentialProviderService
 *
 ...
 */
class KeeGuardCredentialProviderService : CredentialProviderService() {
    ...
    override fun onBeginGetCredentialRequest(
        ...
        scope.launch {
            try {
                ...
                callback.onError(GetCredentialException("error", e.message))
            }
        }
    }
